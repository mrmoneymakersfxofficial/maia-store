    ...
    <div style={{
      ...
      <div style={{ maxWidth: 520 }}>
        ...
        <h1 style={{ fontSize: 22, marginBottom: 12, color: "#f87171" }}>
          Sanity Studio — Configuraci&oacute;n incompleta
        </h1>
        <p style={{ fontSize: 14, color: "#a1a1aa", marginBottom: 24, lineHeight: 1.6 }}>
          La variable de entorno <code style={{ background: "#27272a", padding: "2px 8px", borderRadius: 4, color: "#fbbf24" }}>NEXT_PUBLIC_SANITY_PROJECT_ID</code> no est&aacute; configurada.
        </p>
        <div style={{ background: "#27272a", borderRadius: 8, padding: 16, textAlign: "left", fontSize: 13, color: "#d4d4d8", lineHeight: 1.8 }}>
          ...
          <ol style={{ paddingLeft: 20, margin: "8px 0" }}>
            <li>Ve a <a href="https://vercel.com/dashboard" target="_blank" rel="noreferrer" style={{ color: "#60a5fa" }}>Vercel Dashboard</a> &rarr; tu proyecto &rarr; Settings &rarr; Environment Variables</li>
